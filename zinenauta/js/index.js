...
var NoiseButton = function (_PIXI$Application) {
  ...
  _createClass(NoiseButton, [{
    ...
    value: function createTimeLine() {
      ...
      }).fromTo(this.noiseSprite, 0.5, { x: -(this.noiseSprite.width * 0.66) }, { x: 0 }, "-=.2").to(this.noiseFilter.scale, 0.2, { x: 0, y: 0 }, "-=.2");
    }
  }, {
    key: "play",
    value: function play() {
    ...
    value: function getPolygon(background) {
      ...
      var arrayLines = [[0, points[0]], [points[0], 0], [width - points[1], 0], [width, points[1]], [width, height - points[2]], [width - points[2], height], [points[3], height], [0, height - points[3]], [0, points[0]]];
...
new NoiseButton({
  element: document.querySelector(".noise_btn--border2"),
  polygon: "20, 0, 20, 0",
  wavesPos: {
    y: 0,
    x: 0
...
new NoiseButton({
  element: document.querySelector(".noise_btn--bg2"),
  polygon: "20, 0, 20, 0",
  wavesPos: {
    y: 0,
    x: 0
